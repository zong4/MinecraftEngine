...
void Engine::OpenGLFrameBuffer::BindMultiSampleTexture(int width, int height, int samples)
{
    PROFILE_FUNCTION();
...
void Engine::OpenGLFrameBuffer::BindRenderBuffer(int width, int height, unsigned int internalFormat, int samples)
{
    PROFILE_FUNCTION();
